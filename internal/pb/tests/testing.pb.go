...
var file_tests_testing_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_tests_testing_proto_goTypes = []any{
	...
	(*RowColumnNestedMessage)(nil),            // 17: sf.substreams.sink.files.testing.RowColumnNestedMessage
	(*RowColumnRepeatedNestedMessage)(nil),    // 18: sf.substreams.sink.files.testing.RowColumnRepeatedNestedMessage
	(*RowColumnNestedRepeatedMessage)(nil),    // 19: sf.substreams.sink.files.testing.RowColumnNestedRepeatedMessage
	(*Nested)(nil),                            // 20: sf.substreams.sink.files.testing.Nested
	(*Repeated)(nil),                          // 21: sf.substreams.sink.files.testing.Repeated
	(*IgnoredRow)(nil),                        // 22: sf.substreams.sink.files.testing.IgnoredRow
...
var file_tests_testing_proto_depIdxs = []int32{
	...
	22, // 7: sf.substreams.sink.files.testing.FromTablesRepeatedWithIgnore.ignored:type_name -> sf.substreams.sink.files.testing.IgnoredRow
	...
	23, // 12: sf.substreams.sink.files.testing.Row.typeTimestamp:type_name -> google.protobuf.Timestamp
	23, // 13: sf.substreams.sink.files.testing.RowT.typeTimestamp:type_name -> google.protobuf.Timestamp
	20, // 14: sf.substreams.sink.files.testing.RowColumnNestedMessage.nested:type_name -> sf.substreams.sink.files.testing.Nested
	20, // 15: sf.substreams.sink.files.testing.RowColumnRepeatedNestedMessage.nested:type_name -> sf.substreams.sink.files.testing.Nested
	21, // 16: sf.substreams.sink.files.testing.RowColumnNestedRepeatedMessage.nested:type_name -> sf.substreams.sink.files.testing.Repeated
