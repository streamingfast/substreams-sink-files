...
var file_sf_substreams_sink_files_v1_files_proto_goTypes = []interface{}{
...
func file_sf_substreams_sink_files_v1_files_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sf_substreams_sink_files_v1_files_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Lines); i {
			case 0:
				return &v.state
			case 1:
